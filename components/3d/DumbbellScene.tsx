...
import { SCENE_MODEL } from "@/lib/scene-models";
...
/**
 * Imperative Three.js hex-dumbbell scene (no model cycling).
 */
  ...
  useEffect(() => {
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        orient.rotation.x = SCENE_MODEL.tiltX ?? 0;
        ...
        clone.traverse((obj) => {
          ...
          mats.forEach((mat) => {
            ...
            if (SCENE_MODEL.rubberName && m.name === SCENE_MODEL.rubberName) {
              m.color.set("#1e2229");
              m.roughness = 0.48;
              m.metalness = 0.12;
              if (m.emissive) {
    ...
    const animate = () => {
      ...
      spinRig.rotation.y += clock.getDelta() * spinSpeed;
