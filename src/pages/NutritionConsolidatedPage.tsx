...
import { ForkKnife, Article } from '@phosphor-icons/react'
import { cn } from '@/lib/utils'
import { PageLoader } from '@/components/PageLoader'

const NutritionPage = lazy(() => import('./NutritionPage').then((m) => ({ default: m.NutritionPage })))
const MealPlansPage = lazy(() => import('./MealPlansPage').then((m) => ({ default: m.MealPlansPage })))

const TABS = [
  { id: 'catalog', label: 'Food catalog', icon: ForkKnife, component: NutritionPage },
  { id: 'meal-plans', label: 'Meal plans', icon: Article, component: MealPlansPage },
] as const

export function NutritionConsolidatedPage() {
